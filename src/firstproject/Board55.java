 ...
 * @author Ahmad Syukri
 */
public class Board55 extends javax.swing.JFrame {
    ...
    private void detDraw(){
        ...
        if(!"".equals(one) && !"".equals(two) && !"".equals(three) && !"".equals(four) && !"".equals(five) && 
                !"".equals(six) && !"".equals(seven) && !"".equals(eight) && !"".equals(nine) && !"".equals(ten) &&
                !"".equals(eleven) && !"".equals(twelve) && !"".equals(thirteen) && !"".equals(fourteen) &&
                !"".equals(fifteen) && !"".equals(sixteen) && !"".equals(seventeen) && !"".equals(eighteen) && 
                !"".equals(nineteen) && !"".equals(twenty) && !"".equals(twentyOne) && !"".equals(twentyTwo) && 
               !"".equals(twentyThree) && !"".equals(twentyFour) && !"".equals(twentyFive)){
    ...
    private void determineIfWin(){
        ...
        if("X".equals(six) && "X".equals(seven) && "X".equals(eight) && "X".equals(nine) && "X".equals(ten)){
            winEffect(board6,board7,board8,board9,board10);
            xWins();
        }
        if("X".equals(eleven) && "X".equals(twelve) && "X".equals(thirteen) && "X".equals(fourteen) && "X".equals(fifteen)){
            winEffect(board11,board12,board13,board14,board15);
            xWins();
        }
        if("X".equals(sixteen) && "X".equals(seventeen) && "X".equals(eighteen) && "X".equals(nineteen) && "X".equals(twenty)){
            winEffect(board16,board17,board18,board19,board20);
            xWins();
        }
        if("X".equals(twentyOne) && "X".equals(twentyTwo) && "X".equals(twentyThree) && "X".equals(twentyFour)
                && "X".equals(twentyFive)){
            winEffect(board21,board22,board23,board24,board25);
            xWins();
        }
        if("X".equals(one) && "X".equals(six) && "X".equals(eleven) && "X".equals(sixteen) && "X".equals(twentyOne)){
            winEffect(board1,board6,board11,board16,board21);
            xWins();
        }
        if("X".equals(two) && "X".equals(seven) && "X".equals(twelve) && "X".equals(seventeen) && "X".equals(twentyTwo)){
            winEffect(board2,board7,board12,board17,board22);
            xWins();
        }
        if("X".equals(three) && "X".equals(eight) && "X".equals(thirteen) && "X".equals(eighteen) && "X".equals(twentyThree)){
            winEffect(board3,board8,board13,board18,board23);
            xWins();
        }
        if("X".equals(four) && "X".equals(nine) && "X".equals(fourteen) && "X".equals(nineteen) && "X".equals(twentyFour)){
            winEffect(board4,board9,board14,board19,board24);
            xWins();
        }
        if("X".equals(five) && "X".equals(ten) && "X".equals(fifteen) && "X".equals(twenty) && "X".equals(twentyFive)){
            winEffect(board5,board10,board15,board20,board25);
            xWins();
        }
        if("X".equals(one) && "X".equals(seven) && "X".equals(thirteen) && "X".equals(nineteen) && "X".equals(twentyFive)){
            winEffect(board1,board7,board13,board19,board25);
            xWins();
        }
        if("X".equals(five) && "X".equals(nine) && "X".equals(thirteen) && "X".equals(seventeen) && "X".equals(twentyOne)){
            winEffect(board5,board9,board13,board17,board21);
            xWins();
        }
        
        // if o wins 
        if("O".equals(one) && "O".equals(two) && "O".equals(three) && "O".equals(four) && "O".equals(five)){
            winEffect(board1,board2,board3,board4,board5);
            oWins();
        }
        if("O".equals(six) && "O".equals(seven) && "O".equals(eight) && "O".equals(nine) && "O".equals(ten)){
            winEffect(board6,board7,board8,board9,board10);
            oWins();
        }
        if("O".equals(eleven) && "O".equals(twelve) && "O".equals(thirteen) && "O".equals(fourteen) && "O".equals(fifteen)){
            winEffect(board11,board12,board13,board14,board15);
            oWins();
        }
        if("O".equals(sixteen) && "O".equals(seventeen) && "O".equals(eighteen) && "O".equals(nineteen) && "O".equals(twenty)){
            winEffect(board16,board17,board18,board19,board20);
            oWins();
        }
        if("O".equals(twentyOne) && "O".equals(twentyTwo) && "O".equals(twentyThree) && "O".equals(twentyFour) 
                && "O".equals(twentyFive)){
            winEffect(board21,board22,board23,board24,board25);
            oWins();
        }
        if("O".equals(one) && "O".equals(six) && "O".equals(eleven) && "O".equals(sixteen) && "O".equals(twentyOne)){
            winEffect(board1,board6,board11,board16,board21);
            oWins();
        }
        if("O".equals(two) && "O".equals(seven) && "O".equals(twelve) && "O".equals(seventeen) && "O".equals(twentyTwo)){
            winEffect(board2,board7,board12,board17,board22);
            oWins();
        }
        if("O".equals(three) && "O".equals(eight) && "O".equals(thirteen) && "O".equals(eighteen) && "O".equals(twentyThree)){
            winEffect(board3,board8,board13,board18,board23);
            oWins();
        }
        if("O".equals(four) && "O".equals(nine) && "O".equals(fourteen) && "O".equals(nineteen) && "O".equals(twentyFour)){
            winEffect(board4,board9,board14,board19,board24);
            oWins();
        }
        if("O".equals(five) && "O".equals(ten) && "O".equals(fifteen) && "O".equals(twenty) && "O".equals(twentyFive)){
            winEffect(board5,board10,board15,board20,board25);
            oWins();
        }
        if("O".equals(one) && "O".equals(seven) && "O".equals(thirteen) && "O".equals(nineteen) && "O".equals(twentyFive)){
            winEffect(board1,board7,board13,board19,board25);
            oWins();
        }
        if("O".equals(five) && "O".equals(nine) && "O".equals(thirteen) && "O".equals(seventeen) && "O".equals(twentyOne)){
            winEffect(board5,board9,board13,board17,board21);
            oWins();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Board55.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
