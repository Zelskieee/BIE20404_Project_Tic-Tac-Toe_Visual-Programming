 ...
 * @author Ahmad Syukri
 */
public class Board33_vsBot extends javax.swing.JFrame {
    ...
    private void detDraw(){
        ...
        if(!"".equals(one) && !"".equals(two) && !"".equals(three) && !"".equals(four) && !"".equals(five) && !"".equals(six) && !"".equals(seven) && !"".equals(eight) && !"".equals(nine) ){
    ...
    private void botMove(){
        ...
        int buttonNumber;
        do {
            buttonNumber = (int) (Math.random() * 9) + 1;
    ...
    private void toggleMute() {
        ...
        if (!isMuted && !isBGsoundMuted && !isWinSoundMuted && !isDrawSoundMuted && !isLoseSoundMuted) {
            ...
            audio.setIcon(new ImageIcon("src/img/icons8-mute-16.png")); // Set unmute icon
        } else{
            ...
            audio.setIcon(new ImageIcon("src/img/icons8-voice-16.png")); // Set mute icon
        }
    ...
    private void initComponents() {
        ...
        audio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-voice-16.png"))); // NOI18N
        audio.setFocusPainted(false);
        audio.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        audio.setMaximumSize(new java.awt.Dimension(21, 21));
        audio.setMinimumSize(new java.awt.Dimension(21, 21));
        audio.setPreferredSize(new java.awt.Dimension(21, 21));
        ...
        topPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, topPanelLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(audio, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel2.setLabelFor(titlePanel);
        ...
        player2icon.setMaximumSize(new java.awt.Dimension(76, 30));
        player2icon.setMinimumSize(new java.awt.Dimension(76, 30));
        player2icon.setPreferredSize(new java.awt.Dimension(76, 30));
        ...
        boardPanelLayout.setHorizontalGroup(
            ...
            .addGroup(boardPanelLayout.createSequentialGroup()
                ...
                .addGroup(boardPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(boardPanelLayout.createSequentialGroup()
                        .addComponent(board1, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        btnReset.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-delete-16.png"))); // NOI18N
        ...
        phonePanel.add(bottomPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 504, 248, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Board33_vsBot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Board33_vsBot().setVisible(true);
            }
        });
    }
